...
pr.nn2 <- compute(nn2,X2_TEST[,1:3])
MSE.nn2 <- (X2_TEST[1,4] - pr.nn2$net.result)^2


print("Second iteratiion MSE:")
#print(X2_TEST[1,4])
...
pr.nn3 <- compute(nn3,X3_TEST[,1:3])
MSE.nn3 <- (X3_TEST[1,4] - pr.nn3$net.result)^2

print("Third iteratiion MSE:")
print(MSE.nn3)
